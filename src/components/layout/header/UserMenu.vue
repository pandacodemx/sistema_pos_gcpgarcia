  ...
  <div class="relative" ref="dropdownRef">
    <button class="flex items-center text-gray-700 dark:text-gray-400" @click.prevent="toggleDropdown">
      <span class="mr-3 overflow-hidden rounded-full h-11 w-11">
        <img src="/images/user/icon_user.png" alt="User" />
      </span>

      <span class="block mr-1 font-medium text-theme-sm">{{ auth.user?.nombres }}</span>
...
const menuItems = [
  ...
  { href: '/chat', icon: SettingsIcon, text: 'Configuración Cuenta' },
